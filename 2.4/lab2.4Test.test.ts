...
describe("Employee Manager 1.2", () => {
    ...
    describe("handles error messages correctly", () => {
        ...
        //This assignment is easy to plug "elements" into, but it's much harder think about how to put something like this together from scratch.